        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="/miPerfil#encuestas"><i class="fa fa-btn fa-file-text"></i>Ver Encuestas</a>
                            </li>
                        </ul>
                    </li>
                    @endif
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="{{ url('/cambioContrasena') }}"><i class="fa fa-btn fa-user-secret"></i>Cambiar
                                        contraseña</a></li>
                ...
                <form class="navbar-form navbar-right" role="search" action="/buscar" method="post">
                    ...
                    <button type="submit" class="btn btn-success"><img src="/imgs/toolbar_find.png"
                                                                       style="height: 22px;"></button>
                </form>
